...
//    }
     ...
     * 设置权限信息
     * 
     * @author qianchun  @date 2015年2月11日 下午6:45:02
     * @param key
     * @param value
     * @param during
     * @return
     */
    public long setPermission(String key, List<Permission> value, int during) {
        this.set(key, value);
        return this.expire(key, during);//第二个参数是秒数
    }
    /**
     * 设置功能模块信息
     * 
     * @author qianchun  @date 2015年2月11日 下午6:45:19
     * @param key
     * @param value
     * @param during
     * @return
     */
    public long setFuncIds(String key, List<Long> value, int during) {
        this.set(key, value);
        return this.expire(key, during);//第二个参数是秒数
    }
